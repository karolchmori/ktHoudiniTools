...
class ktTextureImporter(QtWidgets.QDialog):
    ...
    def createWidgets(self):
        ...
        self.patternCMB.addItem('@objName_@texName_*_*_*_*_*_@texType.ext')
        self.patternCMB.addItem('@objName_@texName_*_*_*_*_@texType.ext')
        self.patternCMB.addItem('@objName_@texName_*_*_*_@texType.ext')
        self.patternCMB.addItem('@objName_@texName_*_*_@texType.ext')
